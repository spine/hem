(function() {
  var Dependencies, Module, compilers, detective, extname, fs, mtime, resolve;
  ...
  Dependencies = (function() {
    ...
    Dependencies.prototype.resolve = function() {
      var path;
    ...
    Dependencies.prototype.deepResolve = function(modules, result, search) {
      var module, _i, _len;
      if (modules == null) {
        modules = [];
      }
