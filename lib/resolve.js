(function() {
  var Module, basename, dirname, extname, invalidDirs, isAbsolute, join, modulePaths, modulerize, pathSeparator, pathSeparatorRegex, repl, resolve, _ref,
  ...
  modulerize = function(id, filename) {
    ...
    return join(dirname(id), basename(id, ext)).replace(pathSeparatorRegex, '/');
  };
