...
(function() {
  var checkForRedirect, connect, createReloadProxy, createRoutingProxy, fs, http, httpProxy, log, mime, patchServerResponseForRedirects, server, utils;
  ...
  server.middleware = function(hem) {
    ...
    return function(req, res, next) {
      var result, url, _len4, _m, _ref5, _ref6;
      ...
      if (url.match(/(\.js|\.css)$/)) {
        ...
        for (_m = 0, _len4 = _ref6.length; _m < _len4; _m++) {
          ...
          if (result = app.isMatchingRoute(url)) {
            ...
            res.end((req.method === 'HEAD' && null) || result.source);
            return;
          }
        }
      }
