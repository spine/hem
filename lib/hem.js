(function() {
  ...
  Hem = (function() {
    ...
    Hem.prototype.server = function(callback) {
      ...
      if (path.existsSync(this.options.public)) {
        this.app.use(express.static(this.options.public));
      }
      if (callback) this.app.on('listening', callback);
    ...
    Hem.prototype.exec = function(command, callback) {
