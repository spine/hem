...
(function() {
  ...
  Hem = (function() {
    ...
    Hem.prototype.server = function() {
      var app, child, pkg, process, route, spawn, url, value, _i, _j, _len, _len1, _ref, _ref1;
      app = connect();
      _ref = this.packages;
