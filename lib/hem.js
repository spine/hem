(function() {
  var EventEmitter, Hem, argv, cluster, compilers, css, fs, help, numCPUs, optimist, package, path, specs, strata, sys,
    ...
    Hem.prototype.server = function() {
      ...
      if (cluster && this.isProduction) {
        if (cluster.isMaster) {
          ...
          console.log("worked options " + this.options.host + ":" + this.options.port);
          strata.run(this.app, {
            port: this.options.port,
            host: this.options.host
          });
          return console.log("worker " + process.pid + " online");
        }
      } else {
