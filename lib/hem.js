...
(function() {
  ...
  Hem = (function() {
    ...
    Hem.prototype.server = function() {
      var app, child, pkg, process, route, spawn, url, value, _base, _i, _j, _len, _len1, _ref, _ref1;
      app = connect();
      _ref = this.packages;
      ...
      http.createServer(app).listen(this.options.server.port, this.options.server.host);
      if (this.options.server.spawn__) {
        spawn = this.options.server.spawn;
