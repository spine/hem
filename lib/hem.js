(function() {
  var EventEmitter, Hem, argv, compilers, css, fs, help, optimist, package, path, specs, strata, sys, _ref,
  ...
  Hem = (function(_super) {
    ...
    function Hem(options) {
      ...
      _ref3 = this.readSlug(this.options.serverSlug);
      for (key in _ref3) {
        value = _ref3[key];
    ...
    Hem.prototype.doMapping = function(app) {
      ...
      return app.use(function(app) {
        ...
        return function(env, callback) {
          var _ref2;
          if ((_ref2 = _this.server) != null ? _ref2.router : void 0) {
            try {
    ...
    Hem.prototype.build = function() {
      ...
      this.emit('bustedPaths', {
        "js": bustedJsPath,
        "css": bustedCssPath,
        "path": this.options.public
      });
      console.log("Busted CSS written to " + bustedCssPath + " in " + this.options.public);
      return console.log("Busted JS written to " + bustedJsPath);
    };

    Hem.prototype.clearCacheForDir = function(dir) {
      var file, key, p, stat, _i, _len, _ref2, _results;
    ...
    Hem.prototype.serverBuild = function() {
      var dir, lib, _i, _len, _ref2;
      _ref2 = (function() {
        var _j, _len, _ref2, _results;
        _ref2 = this.serverOptions.paths;
        _results = [];
    ...
    Hem.prototype.watch = function() {
      var dir, lib, _i, _len, _ref2, _results,
        _this = this;
      this.build();
      _ref2 = ((function() {
        var _j, _len, _ref2, _results2;
        _ref2 = this.options.libs;
        _results2 = [];
        for (_j = 0, _len = _ref2.length; _j < _len; _j++) {
          lib = _ref2[_j];
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        if (fs.watch) {
          _results.push(fs.watch(dir, function(event, file) {
            if (file) {
              return console.log("" + file + " changed. Rebuilding.");
            } else {
              return console.log("Something changed. Rebuilding.");
            }
          }));
        } else {
