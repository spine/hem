...
(function() {
  ...
  Hem = (function() {
    ...
    Hem.prototype.packages = [];

    function Hem(options) {
      var config, key, name, slug, slugDir, value, _base, _base1, _base2, _ref, _ref1;
      ...
      for (name in _ref1) {
        ...
        this.packages.push(Package.createPackage(name, config));
      }
    }
    ...
    Hem.prototype.exec = function(command) {
      ...
      switch (command) {
        ...
        case 'clean':
          ...
          break;
        case 'version':
          console.log('Version application');
          break;
        case 'server':
