...
(function() {
  ...
  Hem = (function() {
    ...
    function Hem(options) {
      var config, name, slug, _base, _base1, _base2, _base3, _base4, _base5, _base6, _ref;
      ...
      (_base3 = this.options.hem).test || (_base3.test = {});
      (_base4 = this.options.hem.test).runner || (_base4.runner = "karma");
      (_base5 = this.options.hem.test).reporters || (_base5.reporters = "progress");
      (_base6 = this.options.hem.test).frameworks || (_base6.frameworks = "jasmine");
      if (argv.port) {
    ...
    Hem.prototype.server = function() {
      var app, value, _i, _len, _ref, _results;
