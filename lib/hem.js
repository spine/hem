...
(function() {
  ...
  Hem = (function() {
    ...
    Hem.prototype.server = function() {
      ...
      app = connect();
      app.use("/segway/healthlink/application.js", this.hemPackage().middleware);
      app.use("/segway/healthlink/application.css", this.cssPackage().middleware);
      app.use("/test/specs.js", this.specsPackage().middleware);
      app.use("/segway/healthlink", connect["static"](this.options["public"]));
      app.use("/test", connect["static"](this.options.testPublic));
      app.use("/segway", this.createRoutingProxy({
        host: 'localhost',
        port: 8080
      }));
