(function() {
  ...
  Hem = (function() {
    ...
    Hem.prototype.server = function() {
      ...
      console.log(path.existsSync(this.options.testPublic), this.options.testPublic);
      if (path.existsSync(this.options.testPublic)) {
        this.app.map(this.options.testPath, __bind(function(app) {
          return app.use(strata.static, this.options.testPublic, ['index.html', 'index.htm']);
        }, this));
      }
    ...
    Hem.prototype.build = function() {
      var source;
      source = this.hemPackage().compile(this.options.minify);
