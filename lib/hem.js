...
(function() {
  var Hem, application, argv, compilers, fs, help, optimist, path, server, testing, utils, versions,
  ...
  Hem = (function() {
    ...
    function Hem(options) {
      var config, key, name, slug, value, _base, _base1, _base2, _ref, _ref1;
      ...
      if (this.options.version) {
        ...
        if (!(this.options.version.module = versions[this.options.version.type])) {
          utils.errorAndExit("Incorrect type value for versioning (" + this.options.version.type + ")");
        }
      }
      if (argv.port) {
    ...
    Hem.prototype.server = function() {
      return server.start(this.apps, this.options.server);
    };
    ...
    Hem.prototype.exec = function(command) {
      ...
      switch (command) {
        case 'watch':
          utils.log('Watching application');
          break;
        case 'test':
        ...
        case 'version':
          ...
          break;
        case 'server':
          utils.log("Starting Server at " + this.options.server.host + ":" + this.options.server.port);
      }
      return this[command]();
    };
    ...
    Hem.prototype.buildTargets = function(targets) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        app = _ref[_i];
        _results.push(app.build(!argv.debug));
      }
      return _results;
    };
