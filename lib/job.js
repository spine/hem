...
(function() {
    ...
    Job.prototype.run = function(id, params) {
      ...
      handleError = (function(_this) {
        return function(task, ex) {
          Log.error("(" + _this.app.name + " > " + _this.name + " > " + task.name + ") " + ex.message);
          if (ex.path) {
            Log("       Path: " + ex.path);
          }
          if (err.result) {
  ...
  TaskWrapper = (function() {
    function TaskWrapper(job, config) {
      ...
      for (key in config) {
        value = config[key];
        if (key !== 'job' && key !== 'id' && key !== 'name' && key !== 'task' && key !== 'argv' && key !== 'run' && key !== 'app') {
          this[key] = value;
        }
      }
    ...
    TaskWrapper.prototype.app = function() {
      return this.job.app;
    };
