  ...
  TaskWrapper = (function() {
    ...
    TaskWrapper.prototype.run = function(params) {
      ...
      if (this.task.run && typeof this.task.run === "function") {
        ...
        return Log.errorAndExit("Task '" + this.name + "' does not have a run() method to call.");
      }
    };

    TaskWrapper.prototype.handleError = function(ex, exit) {
      if (exit == null) {
        exit = false;
      }
