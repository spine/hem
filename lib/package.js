...
(function() {
  var Application, CssPackage, Dependency, JsPackage, Package, Stitch, TestPackage, createApplication, fs, path, uglify, utils, versions,
    __slice = [].slice,
  ...
  Application = (function() {
    function Application(name, config) {
      var defaults, err, files, key, packager, pkg, route, value, _base, _ref, _ref1, _ref2,
        _this = this;
      ...
      this.route = this.applyBaseRoute((_ref1 = config.hem) != null ? _ref1.baseAppRoute : void 0, this.route);
      this["static"] = {};
      this.packages = {};
      _ref2 = config["static"];
      for (route in _ref2) {
      ...
      if (this.versioning) {
        ...
        files = utils.toArray(this.versioning.files);
        files = files.map(function(file) {
          return _this.applyRootDir(file)[0];
        });
        this.versioning.files = files;
    ...
    Application.prototype.applyRootDir = function() {
      var values,
        _this = this;
