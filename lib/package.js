...
(function() {
  var Application, CssPackage, Dependency, JsPackage, Package, Stitch, TestPackage, argv, createApplication, events, fs, log, path, uglifycss, uglifyjs, utils, versioning,
    __slice = [].slice,
  ...
  TestPackage = (function(_super) {
    ...
    function TestPackage(app, config) {
      ...
      this.framework = (_ref = this.app.hem.options.hem.tests) != null ? _ref.framework : void 0;
