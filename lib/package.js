...
(function() {
  var Application, CssPackage, Dependency, JsPackage, Package, Stitch, TestPackage, create, events, fs, log, path, uglifycss, uglifyjs, utils, versioning, _argv, _hem,
    __slice = [].slice,
  ...
  TestPackage = (function(_super) {
    ...
    TestPackage.prototype.getAllTestTargets = function(relative) {
      var dep, depapp, homeRoute, pkg, pth, relativeFn, targets, url, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
      if (relative == null) {
        relative = true;
      }
      targets = [];
