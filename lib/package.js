...
(function() {
  var Application, CssPackage, Dependency, JsPackage, Package, Stitch, TestPackage, createApplication, fs, path, uglifycss, uglifyjs, utils, versioning,
    __slice = [].slice,
  ...
  Application = (function() {
    ...
    Application.prototype.watch = function() {
      ...
      if (dirs.length) {
        return utils.info("- Watching directories: <yellow>" + dirs + "</yellow>");
      } else {
        return utils.info("- No directories to watch...");
      }
    };
  ...
  JsPackage = (function(_super) {
    ...
    JsPackage.prototype.compileModules = function() {
      ...
      if (_modules) {
        return _stitch.template(this.identifier, _modules);
      } else {
        return "";
      }
    };
