...
(function() {
  var Dependency, Package, Stitch, fs, mime, path, stitchFile, toArray, uglify,
  ...
  Package = (function() {
    ...
    Package.prototype.compileCache = function(packages, versionAddOn) {};
