...
(function() {
  ...
  module.exports = function(filepath, reportStyle) {
    if (reportStyle == null) {
      reportStyle = "formatColors";
    }
    return phantom.create(function(ph) {
      return ph.createPage(function(page) {
        ...
        return page.open(filepath, function(status) {
          var check, evalTests, parseTestResults, reporter;
          if (status !== "success") {
          ...
          check = function(callback) {
            ...
            return page.evaluate(isTestComplete, callback);
          };
          parseTestResults = function(report) {
            ...
            return window.callPhantom(report(passed.length, fails.length));
          };
          reporter = reporters[reportStyle || "formatColors"];
          evalTests = function(time) {
            return page.evaluate(parseTestResults, (function() {
              return ph.exit();
            }), new String(reporter));
          };
